...
function BackOfficeConnecting() {
  return (
    <div className="bg-white h-screen  pt-0">
      <div  style={{ backgroundImage: `url(${flowers})` }}  className="flex h-72 bg-cover  flex-col space-y-4 justify-center items-center">
        <div className="ml-4">
        ...
        <div className="flex justify-center items-center">
          <div className="w-10 h-10 border-4 my-5  rounded-full flex justify-center items-center">

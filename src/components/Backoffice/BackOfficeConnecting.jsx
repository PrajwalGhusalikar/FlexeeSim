      ...
      <div className="mt-10">
        <div className="bg-gray-200 p-5 rounded-lg">
          ...
          <div className="flex items-center justify-center mt-4">
            <div className="bg-blue-900 w-36 h-40  flex flex-col justify-center items-center mr-2">
              <p className="text-sm font-medium text-white">Suppliers</p>
              <p className="text-xs font-medium text-white">(Raw Material)</p>
            </div>
            <div className="bg-blue-700 w-36 h-40 flex flex-col justify-center items-center mr-2">
              <p className="text-sm font-medium text-white">Procurement</p>
            </div>
            <div className="bg-blue-500  w-36 h-40  flex flex-col justify-center items-center mr-2">
              <p className="text-sm font-medium text-white">Production</p>
            </div>
            <div className="bg-yellow-600 w-36 h-40  flex flex-col justify-center items-center mr-2">
              <p className="text-sm font-medium text-white">Delivery</p>
            </div>
            <div className="bg-red-600 w-36 h-40  flex flex-col justify-center items-center">
